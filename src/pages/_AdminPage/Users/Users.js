...
export default function Users() {
  ...
  const { mangNguoiDung } = useSelector(
  ...
  const columns = [
    ...
    },
    {
      ...
      dataIndex: "taiKhoan",
      render: (text, users, index) => {
        return <Fragment>{users.taiKhoan}</Fragment>;
      },
      width: "18%",
    },
    {
      ...
      dataIndex: "matKhau",
      render: (text, users, index) => {
        return <Fragment>{users.matKhau}</Fragment>;
      },
      // sorter: (a, b) => {
    ...
    },
    {
      ...
      render: (text, users, index) => {
        return <Fragment>{users.hoTen}</Fragment>;
      },
      width: "25%",
      sortDirections: ["descend", "ascend"],
    },
    {
      ...
      render: (text, users, index) => {
        return <Fragment>{users.email}</Fragment>;
      },
      width: "25%",
      sortDirections: ["descend", "ascend"],
    },
    {
      ...
      render: (text, users, index) => {
        return <Fragment>{users.soDt}</Fragment>;
      },
      width: "10%",
      sortDirections: ["descend", "ascend"],
    },
          ...
          <Fragment>
            ...
            <span
              ...
              onClick={() => {
                if (
                  window.confirm(
                    "Bạn có chắc muốn xóa người dùng?" + users.hoTen
                  )
                ) {
                  // Gọi action xóa
